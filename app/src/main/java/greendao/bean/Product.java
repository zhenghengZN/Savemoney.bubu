...
public class Product implements Parcelable {
    ...
    private List<Document> productPhotoList;
    ...
    public Product(String objectId, Integer index, Integer comments, Integer likes, String desc, String title, String rowStatus, String places, String photos, Integer suggestedPrice, String suggestedShops, Double rating, String urls, String suggestedBrands, String createdAt, String updatedAt, String guideId) {
        this.objectId = objectId;
        this.index = index;
        ...
        this.suggestedShops = suggestedShops;
        this.rating = rating;
        this.urls = urls;
    ...
    public String getSuggestedShops() {
        return suggestedShops;
    }

    public void setSuggestedShops(String suggestedShops) {
        this.suggestedShops = suggestedShops;
    }
    ...
    public List<Place> getPlaceList() {
        if (placeList == null) {
            ...
            List<Place> placeListNew = targetDao._queryProduct_PlaceList(objectId);
            synchronized (this) {
                if(placeList == null) {
    ...
    /** To-many relationship, resolved on first access (and after reset). Changes to to-many relations are not persisted, make changes to the target entity. */
    public List<Document> getProductPhotoList() {
        if (productPhotoList == null) {
            if (daoSession == null) {
                throw new DaoException("Entity is detached from DAO context");
            }
            DocumentDao targetDao = daoSession.getDocumentDao();
            List<Document> productPhotoListNew = targetDao._queryProduct_ProductPhotoList(objectId);
            synchronized (this) {
                if(productPhotoList == null) {
                    productPhotoList = productPhotoListNew;
                }
            }
        }
    ...
    /** Resets a to-many relationship, making the next get call to query for a fresh result. */
    public synchronized void resetProductPhotoList() {
        productPhotoList = null;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.suggestedShops);
        dest.writeValue(this.rating);
        dest.writeString(this.urls);
        dest.writeString(this.suggestedBrands);
        ...
        dest.writeList(this.productPhotoList);
    }
    ...
    protected Product(Parcel in) {
        ...
        this.suggestedShops = in.readString();
        this.rating = (Double) in.readValue(Double.class.getClassLoader());
        this.urls = in.readString();
        this.suggestedBrands = in.readString();
        ...
        in.readList(this.placeList, Place.class.getClassLoader());
        this.productPhotoList = new ArrayList<Document>();
        in.readList(this.productPhotoList, Document.class.getClassLoader());
    }
